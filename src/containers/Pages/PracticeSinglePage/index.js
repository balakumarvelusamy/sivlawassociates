...
const breadcumbMenu = [{ name: "Home", route: "/" }, { name: "Practice", route: "/practice" }, { name: "Practice area details" }];
...
const PracticeSinglePage = () => {
  return (
    <Fragment>
      ...
      <Breadcumb className="breadcumbArea" title="Practice Single Area" breadcumbMenu={breadcumbMenu} background={breadcumb} />
