...
const DisclaimerContent =()=>{
    ...
    <h1>Disclaimer</h1>
<p>As per the rules of the Bar Council of India, we are not permitted to solicit work or advertise for our services. The user acknowledges the following:</p>

<ul>
 <li>There has been no advertisement, personal communication, solicitation, invitation or inducement of any kind whatsoever from us or any 	of our members to solicit any work through this website;</li>
